...
public class BluetoothReaderService {
    ...
    private static final String NAME = "BluetoothReader";
    ...
    public static final int STATE_UNCONNECT = 4; // now initiating an outgoing connection
    public static final int STATE_LOSTCONNECT = 5;  // now connected to a remote device
