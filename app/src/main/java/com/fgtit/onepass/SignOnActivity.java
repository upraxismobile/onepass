...
import android_serialport_api.AsyncFingerprint.OnMatchListener;
...
public class SignOnActivity extends Activity {
	...
	//	GlobalData.getInstance().recordList1.add(rs);
		...
		String text="Hon'ble Guardian, Your child"+ person.name+" has entered into School at "+ExtApi.getStringDate1();
