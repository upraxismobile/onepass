...
public class SocketClient {
	...
	public final static byte MSG_STATUS=0x03;
	...
	public class ClientThread implements Runnable {
		public void run() {
			try  {
				...
				try{
					...
					try	{
						...
						handler.post(new Runnable() {
							public void run() {
								//textStatus.setText("网络错误3:" + error);
					...
					handler.post(new Runnable() {
						public void run() {
							//textStatus.setText("网络错误2:" + error);
			...
			catch (Exception e)
			{
				...
				{
					public void run() {
						//textStatus.setText("网络错误1:" + error);
